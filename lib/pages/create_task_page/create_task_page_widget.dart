...
class CreateTaskPageWidget extends StatefulWidget {
  ...
  @override
  State<CreateTaskPageWidget> createState() => _CreateTaskPageWidgetState();
}
...
class _CreateTaskPageWidgetState extends State<CreateTaskPageWidget> {
  ...
  void initState() {
    ...
    _model.taskController ??= TextEditingController(text: widget.taskTitle);
                                        ...
                                        child: Padding(
                                          ...
                                          child: Text(
                                            () {
                                              ...
                                              } else if (widget.taskDeadline !=
                                                  null) {
                                                return dateTimeFormat('MMMEd',
                                                    widget.taskDeadline);
                                              } else {
                  ...
                  child: Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: !((_model.taskController.text != '') &&
                              ...
                              ((widget.taskDeadline != null) ||
                                  (_model.datePicked != null)))
                          ? null
                          : () async {
                              context.pushNamed(
                                'TasksBrokenDownScreen',
                                queryParameters: {
                                  'taskTitle': serializeParam(
                                    _model.taskController.text,
                                    ParamType.String,
                                  ),
                                  'taskDeadline': serializeParam(
                                    _model.datePicked ?? widget.taskDeadline,
                                    ParamType.DateTime,
                                  ),
                                  ...
                                  'taskBreakdownLevel': serializeParam(
                                    0,
                                    ParamType.int,
                                  ),
                                }.withoutNulls,
